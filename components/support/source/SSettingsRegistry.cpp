 ...
 *  @brief Source file implementing the SSettingsRegistry singleton class and its methods.
 *
    ...
    namespace Support
    {
        ...
        SSettingsRegistry::~SSettingsRegistry(void)
        {
            ...
            if (config)
            {
                ...
                // Header comments---------------------
                al_add_config_comment(config, nullptr, "Configuration values for the operation of the KGE");
                al_add_config_comment(config, nullptr, tempBuffer);
