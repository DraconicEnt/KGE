...
namespace Kiaro
{
	namespace Network
	{
		...
		class OutgoingClient
		{
			 ...
			 */
            void Connect(const Kiaro::Common::C8 *target_address, const Kiaro::Common::U16 target_port, const Kiaro::Common::U32 wait = 5000);
