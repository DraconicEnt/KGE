...
#ifndef _INCLUDE_KIARO_LOGGING_H_
#define _INCLUDE_KIARO_LOGGING_H_
...
namespace Kiaro
{
    namespace Logging
    {
         ...
         */
        Kiaro::Common::U32 Write(Kiaro::Support::String input, LEVEL_NAME log_level = LEVEL_INFO, Kiaro::Common::U32 arg_count = 0, ...);
    } // End NameSpace Logging
} // End NameSpace Kiaro
#endif // _INCLUDE_KIARO_LOGGING_H_
