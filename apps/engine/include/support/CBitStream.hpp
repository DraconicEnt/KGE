    ...
    namespace Support
    {
        ...
        class CBitStream
        {
            ...
            public:
                 ...
                 */
                CBitStream(const size_t &initialDataIndex = 0, const size_t &allocationSize = 32);
                 ...
                 */
                CBitStream(const void *inData, const size_t &inDataLength, const size_t &allocationSize = 32);
                ...
                void read(ISerializable *copyTo)
                {
