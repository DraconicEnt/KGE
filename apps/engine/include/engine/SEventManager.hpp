...
namespace Kiaro
{
    ...
    namespace Engine
    {
        class SEventManager
        {
            ...
            // Public Typedefs
            public:
                typedef EasyDelegate::DelegateSet<void, Kiaro::Network::CClient*> onClientConnectedEventType;
                typedef EasyDelegate::DelegateSet<void, Kiaro::Network::CClient*> onClientDisconnectedEventType;
