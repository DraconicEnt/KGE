...
#ifndef _INCLUDE_ENGINE_BULLETDEBUGDRAWER_HPP_
#define _INCLUDE_ENGINE_BULLETDEBUGDRAWER_HPP_
...
namespace Kiaro
{
    namespace Engine
    {
        class BulletDebugDrawer : public btIDebugDraw
        {
            // Public Methods
            public:
                BulletDebugDrawer(irr::IrrlichtDevice *irrlicht);
...
#endif // _INCLUDE_ENGINE_BULLETDEBUGDRAWER_HPP_
